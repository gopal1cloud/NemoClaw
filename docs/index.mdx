...
For the canonical list of supported platforms, inference providers, agents, messaging integrations, and deployment paths with explicit status per row, see [Platform Support and Launch Claims](./reference/platform-support).
