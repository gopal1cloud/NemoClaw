...
For the full canonical matrix including deferred platforms, inference providers, agents, messaging integrations, and deployment paths, see [Platform Support and Launch Claims](../reference/platform-support).
