...
- Docker (running)
- [uv](https://docs.astral.sh/uv/) (for Python dependency management; install it before running the blueprint setup commands below, which invoke `uv sync`)
...
# Install Python deps for the blueprint (requires uv from the prerequisites above)
