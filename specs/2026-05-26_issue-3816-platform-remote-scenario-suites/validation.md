...
### Scenario 1.1: Inventory completeness is machine-validated [STATUS: pending]
**Type**: Happy Path
...
### Scenario 1.2: Inventory simplification is rejected [STATUS: pending]
**Type**: Sad Path
...
### Scenario 2.1: Platform remote helper is context-driven and secret-safe [STATUS: pending]
**Type**: Happy Path
...
### Scenario 3.1: GPU/local Ollama and re-onboard plans are valid [STATUS: pending]
**Type**: Happy Path
...
### Scenario 3.2: GPU live suite is skipped/deferred without GPU runner [STATUS: pending]
**Type**: Sad Path
...
### Scenario 4.1: Launchable and public install prove live cloud path on PR branch [STATUS: pending]
**Type**: Happy Path
...
### Scenario 4.2: Missing `NVIDIA_API_KEY` skips cloud live checks explicitly [STATUS: pending]
**Type**: Sad Path
...
### Scenario 5.1: DGX Spark and Jetson remain represented despite manual runners [STATUS: pending]
**Type**: Happy Path
...
### Scenario 6.1: macOS and WSL workflow metadata is preserved [STATUS: pending]
**Type**: Happy Path
...
### Scenario 6.2: WSL negative platform assertions classify failures correctly [STATUS: pending]
**Type**: Sad Path
